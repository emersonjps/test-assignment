...
export default function Steps() {
  return (
    <section className="steps flex max-w-full justify-center gap-10 mt-10">
      ...
      <div className="item flex items-center">
        <div className="flex flex-row mr-5">
          ...
          <p className="number_staps -ml-5 mt-0.5 text-white">3</p>
        </div>
      ...
      <div className="item flex items-center">
        <div className="flex flex-row mr-5">
          <Image
            ...
            height={42}
          />{" "}
          <p className="number_staps text_steps -ml-5 mt-0.5 text_steps_blue">
            4
          </p>
        </div>
